<div class="mt-6">
    <div class="max-w-4xl px-10 py-6 bg-white rounded-lg shadow-md">
        ...
        <div class="mt-2">
            <a class="text-2xl text-gray-700 font-bold hover:underline" href="{{ route('posts.show', ['postId' => $postId]) }}">{{ $title }}</a>
        ...
        <div class="flex justify-between items-center mt-4">
            ...
            <a class="text-blue-500 hover:underline" href="{{ route('posts.update', ['postId' => $postId]) }}">Edit</a>
            <div>
